...
joint_pos[:, 4] = -1.5708 # wrist_2_joint
...
print("Z-axis:", r.apply([0, 0, 1]))
print("Local pos:", env.robot.data.body_pos_w[0, env.palm_link_idx].cpu().numpy() - env.scene.env_origins[0].cpu().numpy())
env.close()
